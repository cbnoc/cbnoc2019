...
def main(table=True):
    ...
    subnets = [
        ...
        '10.1.8.0/255.255.248.0',
        '10.1.16.0/255.255.255.0',
        '202.1.208.0/255.255.240.0',
        '202.236.88.0/255.255.255.0',
        '202.236.89.0/255.255.255.0',
        '202.236.90.0/255.255.255.0',
        '202.236.91.0/255.255.255.0',
        '202.236.92.0/255.255.255.0',
        '202.236.93.0/255.255.255.0',
        '202.236.94.0/255.255.255.0',
        '202.236.95.0/255.255.255.0',
    ]
